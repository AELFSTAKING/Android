...
public class InfoViewListener implements OnChartValueSelectedListener {
    ...
    public InfoViewListener(Context context, OnSelectListener onSelectListener, double lastClose, List<HisData> list, ChartInfoView infoView, Chart... otherChart) {
        mWidth = DisplayUtils.getWidthHeight(context)[0];
        mLastClose = lastClose;
    ...
    public InfoViewListener(Context context, OnSelectListener onSelectListener, double lastClose, List<HisData> list) {
        mWidth = DisplayUtils.getWidthHeight(context)[0];
        mLastClose = lastClose;
        mOnSelectListener = onSelectListener;
        mList = list;
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        if (mOnSelectListener != null) mOnSelectListener.onSelect(mList, x);
    }
