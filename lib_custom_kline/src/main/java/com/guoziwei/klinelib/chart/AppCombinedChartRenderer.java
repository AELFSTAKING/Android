...
public class AppCombinedChartRenderer extends DataRenderer {
    ...
    public void setDigits(int digits) {
        mDigits = digits;
        if (mRenderers != null && mRenderers instanceof CandleStickChartRenderer)
            ((CandleStickChartRenderer) mRenderers).setDigits(digits);
    }
            ...
            switch (order) {
                ...
                case CANDLE:
                    if (chart.getCandleData() != null)
                        mRenderers.add(new CandleStickChartRenderer(chart, mAnimator, mViewPortHandler).setDigits(mDigits));
