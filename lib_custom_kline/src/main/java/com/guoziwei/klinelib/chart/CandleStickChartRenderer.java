...
public class CandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public CandleStickChartRenderer setDigits(int digits) {
        mDigits = digits;
        return this;
    }
    ...
    public void drawValues(Canvas c) {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            ...
            if (maxIndex > minIndex) {
                //画右边
                String highString = "← " + DoubleUtil.getStringByDigits(minValue, mDigits);
            ...
            if (maxIndex > minIndex) {
                //画左边
                String highString = DoubleUtil.getStringByDigits(maxValue, mDigits) + " →";
