...
public class TradeEditText2 extends LinearLayout implements TextWatcher {
    ...
    public TradeEditText2(Context context) {
        this(context, null);
    }

    public TradeEditText2(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        LayoutInflater.from(context).inflate(R.layout.view_trade_edittext_2, this, true);
        initView();
    }
