...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
        ...
        mBuilder.setContentTitle("开始下载")
                ...
                .setLargeIcon(AppUpdateUtils.drawableToBitmap(
                        AppUpdateUtils.getAppIcon(DownloadService.this)))
                .setOngoing(true)
                .setAutoCancel(true)
    ...
    private void startDownload(UpdateAppBean updateApp, final DownloadCallback callback) {
        ...
        updateApp.getHttpManager().download(apkUrl, target, appName,
                new FileDownloadCallBack(callback));
    }
            ...
            if (oldRate != rate) {
                ...
                if (mBuilder != null) {
                    mBuilder.setContentTitle(
                            "正在下载：" + AppUpdateUtils.getAppName(DownloadService.this))
                            .setContentText(rate + "%")
        ...
        public void onResponse(File file) {
            ...
            try {
                ...
                if (AppUpdateUtils.isAppOnForeground(DownloadService.this) || mBuilder == null) {
                    ...
                    Intent installAppIntent = AppUpdateUtils.getInstallAppIntent(
                            DownloadService.this, file);
