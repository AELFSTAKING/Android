...
//    }
    ...
    private boolean verify() {
        //版本忽略
        if (mShowIgnoreVersion && AppUpdateUtils.isNeedIgnore(mActivity,
                mUpdateApp.getNewVersion())) {
            return true;
        }
...
//                || !mTargetPath.startsWith(preSuffix)
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder setUpdateDialogFragmentListener(
        ...
        public UpdateAppManager build() {
            //校验
            if (getActivity() == null || getHttpManager() == null || TextUtils.isEmpty(
                    getUpdateUrl())) {
