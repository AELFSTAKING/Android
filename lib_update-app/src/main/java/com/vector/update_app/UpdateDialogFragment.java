...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private int mDefaultColor = 0xff0f103e;
    private int mDefaultPicResId = R.mipmap.lib_update_app_top;
    ...
    public UpdateDialogFragment setUpdateDialogFragmentListener(
            IUpdateDialogFragmentListener updateDialogFragmentListener) {
...
//        getDialog().getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL);
        ...
        getDialog().setOnKeyListener(new DialogInterface.OnKeyListener() {
            ...
            public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK) {
                    //禁用
                    if (mUpdateApp != null && mUpdateApp.isForcedUpdate()) {
                        //返回桌面
                        startActivity(
    ...
    private void initData() {
        ...
        if (mUpdateApp != null) {
            ...
            final String targetSize = mUpdateApp.getFileSize();
            final String summary = mUpdateApp.getSummary();
            ...
            mTitleTextView.setText(
                    TextUtils.isEmpty(dialogTitle) ? String.format("是否升级到%s版本？", newVersion)
                            : dialogTitle);
            //强制更新
            if (mUpdateApp.isForcedUpdate()) {
    ...
    private void initTheme() {
        ...
        if (-1 == topResId) {
            ...
            if (-1 == color) {
                //自动提色
//                Palette.from(AppUpdateUtils.drawableToBitmap(this.getResources().getDrawable
// (topResId))).generate(new Palette.PaletteAsyncListener() {
//                    @Override
...
//                });
    ...
    private void setDialogTheme(int color, int topResId) {
        ...
        mUpdateOkButton.setBackgroundDrawable(
                DrawableUtil.getDrawable(AppUpdateUtils.dip2px(4, getActivity()), color));
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.btn_ok) {
            ...
            //权限判断是否有访问外部存储空间权限
            int flag = ActivityCompat.checkSelfPermission(getActivity(),
...
//            }
    ...
    private void installApp() {
        if (AppUpdateUtils.appIsDownloaded(mUpdateApp)) {
            AppUpdateUtils.installApp(UpdateDialogFragment.this,
                    AppUpdateUtils.getAppFile(mUpdateApp));
            //安装完自杀
            ...
            if (mUpdateApp.isHideDialog() && !mUpdateApp.isForcedUpdate()) {
                dismiss();
            }
...
//        Log.e("", "对话框 requestCode = [" + requestCode + "], resultCode = [" + resultCode + "],
// data = [" + data + "]");
//        switch (resultCode) {
