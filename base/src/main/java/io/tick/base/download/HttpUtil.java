...
public class HttpUtil {
    ...
    private final static long CONNECT_TIMEOUT = 24 * 60 * 60;//超时时间，秒
    private final static long READ_TIMEOUT = 24 * 60 * 60;//读取时间，秒
    private final static long WRITE_TIMEOUT = 24 * 60 * 60;//写入时间，秒
