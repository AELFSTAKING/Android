...
public class LegacyEOSKeystore extends V3Keystore {
    ...
    @Deprecated
    public LegacyEOSKeystore(Metadata metadata, String address, String password, String prvKeyHex,
            String id) {
    ...
    public static LegacyEOSKeystore create(Metadata metadata, String accountName, String password,
            String prvKeyHex) {
