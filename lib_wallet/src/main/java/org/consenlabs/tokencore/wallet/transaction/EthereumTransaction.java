...
public class EthereumTransaction implements TransactionSigner {
    ...
    public EthereumTransaction(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit,
            String to,
    ...
    private static SignatureData createEip155SignatureData(SignatureData signatureData,
            int chainId) {
    ...
    public TxSignResult signTransaction(String chainID, String password, Wallet wallet) {
        ...
        String signedTx = signTransaction(Integer.parseInt(chainID),
                wallet.decryptMainKey(password));
