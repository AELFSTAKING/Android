...
public class Messages {
    ...
    public static final String UNSUPPORT_ENCRYPTION_DATA_VERSION =
            "unsupport_encryption_data_version";
    public static final String INVALID_ENCRYPTION_DATA_SIGNATURE =
            "invalid_encryption_data_signature";

    public static final String ENCRYPT_XPUB_ERROR = "encrypt_xpub_error";

    public static final String SEGWIT_NEEDS_COMPRESS_PUBLIC_KEY =
    ...
    public static final String KEYSTORE_CONTAINS_INVALID_PRIVATE_KEY =
            "keystore_contains_invalid_private_key";
