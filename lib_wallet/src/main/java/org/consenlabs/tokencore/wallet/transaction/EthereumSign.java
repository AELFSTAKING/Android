...
public class EthereumSign {
     ...
     */
    private static BigInteger signedMessageToKey(byte[] message, SignatureData signatureData)
        ...
        return NumericUtil.bytesToBigInteger(
                Arrays.copyOfRange(pubKeyBytes, 1, pubKeyBytes.length));
    }
